...
enum UITYPE { UI_DUNGEON, UI_WEAPON,UI_INVEN, UI_INVENCHEST, UI_INVENSHOP,UI_BOSS, UI_END };
...
enum KEYTYPE{ KEY_UI, KEY_PRICE0, KEY_PRICE1, KEY_SHOPOPEN,KEY_PRICE2, KEY_PRICE3, KEY_INVEN, KEY_TALK, KEY_SIGN, KEY_MOVE, KEY_ATTACK, KEY_BOSS, KEY_MODE,KEY_END};

enum OBJID { OBJ_MONSTER,OBJ_BOSS, OBJ_PLAYER, OBJ_NPC, OBJ_PLAYER_ARROW, OBJ_MONSTER_BULLET, OBJ_MAPOBJ, OBJ_NOCOL, OBJ_FLOOR, OBJ_SLIME, OBJ_PORTAL,OBJ_ITEM, OBJ_END};
