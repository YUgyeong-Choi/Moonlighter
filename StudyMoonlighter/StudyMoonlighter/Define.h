...
enum SCENEID { SC_MENU, SC_TUTORIAL, SC_EDIT, SC_VILLAGE, SC_FIELD, SC_GOLEMBOSS, SC_GOLEMDUNGEON, SC_ANIM, SC_END };
...
enum OBJID { OBJ_MONSTER,OBJ_PLAYER, OBJ_NPC,OBJ_MONSTER_BULLET, OBJ_MAPOBJ, OBJ_FLOOR, OBJ_SLIME, OBJ_PORTAL, OBJ_END};
