...
enum UITYPE { UI_DUNGEON, UI_WEAPON,UI_INVEN, UI_SHOPBASIC, UI_INVENSHOP,UI_BOSS, UI_POTIONSHOP, UI_END };
...
enum KEYTYPE{ KEY_UI, KEY_PRICE0, KEY_PRICE1, KEY_SHOPOPEN,KEY_PRICE2, KEY_PRICE3, KEY_INVEN, KEY_TALK, KEY_SIGN, KEY_MOVE, KEY_ATTACK, KEY_BOSS, KEY_SHOP, KEY_MODE,KEY_END};
