...
enum SCENEID { SC_MENU, SC_TUTORIAL, SC_EDIT, SC_VILLAGE, SC_FIELD, SC_GOLEMBOSS, SC_GOLEMDUNGEON,SC_END };
enum PORTALTYPE { VILLAGE, FIELD, DUNGEON,GOLEMBOSS, PORTAL_END };

enum OBJID { OBJ_MONSTER,OBJ_PLAYER, OBJ_MONSTER_BULLET, OBJ_MAPOBJ, OBJ_FLOOR, OBJ_SLIME, OBJ_PORTAL, OBJ_END};
