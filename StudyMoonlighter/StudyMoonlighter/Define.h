...
enum SCENEID { SC_MENU, SC_STARTANI,SC_TUTORIAL, SC_EDIT, SC_VILLAGE, SC_FIELD, SC_GOLEMBOSS, SC_GOLEMDUNGEON, SC_FINALANI,SC_SHOP,SC_END };
enum PORTALTYPE { VILLAGE, SHOP, FIELD, DUNGEON,GOLEMBOSS, PORTAL_END };
enum UITYPE { UI_DUNGEON, UI_WEAPON,UI_INVEN, UI_SHOPBASIC, UI_INVENSHOP,UI_BOSS, UI_POTIONSHOP, UI_GAMBLE,UI_END };
enum ITEMTYPE{BROKENSWORD, FABRIC, HARDENEDSTEEL, IRONBAR, RICHJELLY, TEETHSTONE, WATERSPHERE, WHETSTONE, SWORD, BOW, POTION,ITEM_END};
enum OUTFITTYPE{HELMET, ARMOR, BOOTS, WEAPON1, WEAPON2, OUTFIT_POTION, OUTFIT_ITEM, OUTFIT_END};

enum DEADOBJ{SLIME, HERMIT, SOLDIER, DEAD_END};

enum KEYTYPE{ KEY_UI, KEY_PRICE0, KEY_PRICE1, KEY_SHOPOPEN,KEY_PRICE2, KEY_PRICE3, KEY_INVEN, KEY_TALK, KEY_SIGN, KEY_MOVE, KEY_ATTACK, KEY_BOSS, KEY_SHOP, KEY_GAMBLE,KEY_MODE,KEY_END};

enum OBJID { OBJ_PLAYER, OBJ_MONSTER,OBJ_BOSS, OBJ_NPC, OBJ_PLAYER_ARROW, OBJ_MONSTER_BULLET, OBJ_MAPOBJ, OBJ_NOCOL, OBJ_FLOOR, OBJ_SLIME, OBJ_PORTAL,OBJ_ITEM, OBJ_END};
...
enum MAPOBJ { COLLISION, SCROLLWASD, GOLEM_DOOR, SCROLLROLL, GOLEM_HOLE, GOLEM_BROKEN, GOLEM_BROKEN2,SLIME_PUDDLE,DUNGEON_SCROLL, MAPOBJ_END };
enum HOLETYPE {HOLE_1, HOLE_2, HOLE_3, HOLE_END};
enum TUTORIALSCROLL {SCROLL_HOLE, SCROLL_PROJECTILE, SCROLL_ENEMY, SCROLL_END};

enum CHANNELID { SOUND_EFFECT, SOUND_BGM, PLAYER_EFFECT, MONSTER_EFFECT, ARROW_EFFECT, SOUND_END };
