...
enum MAPOBJ { COLLISION, SCROLLWASD, GOLEM_DOOR, SCROLLROLL, GOLEM_HOLE, GOLEM_BROKEN, MAPOBJ_END };
enum HOLETYPE {HOLE_1, HOLE_2, HOLE_3, HOLE_END};
enum TUTORIALSCROLL {SCROLL_HOLE, SCROLL_PROJECTILE, SCROLL_ENEMY, SCROLL_END};

enum CHANNELID { SOUND_EFFECT, SOUND_BGM, PLAYER_EFFECT, SOUND_END };
