...
void CDungeonEditScene::Create_MapObj()
{
	...
	CObjectManager::Get_Instance()->Add_Object(OBJ_MONSTER, CAbstractFactory<CGolemHead>::Create(700, 100));
	CObjectManager::Get_Instance()->Add_Object(OBJ_MONSTER, CAbstractFactory<CGolemHead>::Create(700, 600));
}
