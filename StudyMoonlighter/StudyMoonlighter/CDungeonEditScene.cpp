...
{
	HANDLE hFile = CreateFile(L"../Data/CTutorialMapObj2.dat", GENERIC_WRITE, NULL, NULL, CREATE_ALWAYS, FILE_ATTRIBUTE_NORMAL, NULL);
...
{
	HANDLE hFile = CreateFile(L"../Data/CTutorialMapObj2.dat", GENERIC_READ, NULL, NULL, OPEN_EXISTING, FILE_ATTRIBUTE_NORMAL, NULL);
